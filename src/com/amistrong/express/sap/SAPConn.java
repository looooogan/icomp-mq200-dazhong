...
public class SAPConn {  
    ...
    static{  
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_ASHOST, "10.228.7.117");//服务器  
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_USER,   "MS-MM");  //SAP用户名  
